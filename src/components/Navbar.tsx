  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 py-4 px-6 transition-all duration-300 ${
        scrolled 
          ? `${isDark ? 'bg-pathscout-dark/80' : 'bg-white/80'} backdrop-blur-md shadow-md` 
          : 'bg-transparent'
      }`}
    >
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-background/95 dark:bg-pathscout-dark/95 backdrop-blur-md shadow-lg py-4 px-6 flex flex-col space-y-4 animate-fade-in">
